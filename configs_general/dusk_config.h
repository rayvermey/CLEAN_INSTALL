...
static const int iconsize                = 18;  /* icon size */
...
static const char *fonts[]               = { "JetBrainsMono Nerd Font","Noto Color Emoji,monospace:size=14" };
...
static const Rule clientrules[] = {
	...
	{ .wintype = WTYPE "SPLASH", .flags = AlwaysOnTop|Centered|Floating },
        { .title = "TermScratchpad (w)", .workspace = "8", .floatpos = "50% 50% 80% 80%", .scratchkey = 'w', .flags = AlwaysOnTop|Floating|Terminal|IgnoreCfgReqPos|IgnoreCfgReqSize|IgnoreDecorationHints|SemiScratchpad },
        { .class = "Slack", .workspace = "5", .floatpos = "50% 50% 80% 80%", .scratchkey = 's', .flags = AlwaysOnTop|Floating|Terminal|IgnoreCfgReqPos|IgnoreCfgReqSize|IgnoreDecorationHints|SemiScratchpad},
        { .class = "Spacefm", .workspace = "8", .floatpos = "100% 100% 100% 100%", .scratchkey = 't', .flags = AlwaysOnTop|Floating|IgnoreCfgReqPos|IgnoreCfgReqSize|IgnoreDecorationHints|SemiScratchpad },
	{ .instance = "spfm (r)", .scratchkey = 'r', .flags = Floating },
	{ .instance = "sfm", .scratchkey = 't', .flags = Floating },
...
//	{ .class = "Alacritty", .flags = Terminal },
	...
	{ .class = "VivRay", .workspace = "1", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
	{ .class = "vivaldi-stable (/home/ray/Ray)", .workspace = "1", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
	{ .class = "Chrome", .workspace = "2", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
	{ .class = "Evernote", .workspace = "4", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
	 { .class = "ICE-SSB-evernote", .workspace = "4", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "TelegramDesktop", .workspace = "3" },
	{ .class = "Element", .workspace = "3" },
	{ .class = "Caprine", .workspace = "5" },
	{ .class = "Whatsapp-for-linux", .workspace = "5" },
	{ .class = "discord", .workspace = "5" },
	{ .class = "Vivaldi-stable", .workspace = "9" },
};
...
static const BarRule barrules[] = {
	...
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       1,     0,       5,   5,   9,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status9" },
	...
	{  0,       1,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,  size_wintitle_hidden,     draw_wintitle_hidden,    click_wintitle_hidden,    NULL,                     "wintitle_hidden" },
	{  0,       1,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT_RIGHT,   size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       1,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT_LEFT,    size_wintitle_floating,   draw_wintitle_floating,  click_wintitle_floating,  NULL,                     "wintitle_floating" },
};
...
static const WorkspaceRule wsrules[] = {
	...
	{  "1",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟣:Viv",   "",   "𝟭:Viv", },
	{  "2",   -1,       0,       9,       .80,   -1,       -1,      -1,    "𝟤:Chr",   "",   "𝟮:Chr", },
	{  "3",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟥:CHAT",   "",   "𝟯:CHAT", },
	{  "4",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟦:EN",   "",   "𝟰:EN", },
	{  "5",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟧:CHAT",   "",   "𝟱:CHAT", },
	{  "6",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟨",   "",   "𝟲", },
	{  "7",   -1,       0,       10,      .75,   -1,       -1,      -1,    "𝟩",   "",   "𝟳", },
	{  "8",   -1,       0,       1,       -1,    -1,       -1,      -1,    "𝟪",   "",   "𝟴", },
	{  "9",   -1,       0,       0,       -1,    -1,       -1,      -1,    "𝟫:Mail",   "",   "𝟵:Mail", },
};
...
static const char *spcmd1[] = {"w", "alacritty", "--title", "TermScratchpad (w)", NULL };
static const char *spcmd2[] = {"t", "spacefm", NULL };
static const char *spcmd3[] = {"s", "slack", NULL };
...
static Key keys[] = {
 ...
 { KeyPress,   MODKEY|Alt,                       XK_g,             setlayout,              {.v = &layouts[12]} }, // sets a specific layout, see the layouts array for indices
	...
	{ KeyPress,   MODKEY|ShiftMask,             XK_equal,         changeopacity,          {.f = +0.05 } }, // increase the client opacity (for compositors that support _NET_WM_OPACITY)
...
//	STACKKEYS(AltGr|Ctrl|Shift,                      stackpush)                            // move the currently focused client to the nth place in the stack
	...
	SCRATCHKEYS(                    XK_t,                                    spcmd2)
	SCRATCHKEYS(                    XK_s,                                    spcmd3)
