...
static const char *fonts[]               = { "JetBrainsMono Nerd Font","Noto Color Emoji:style=Regular:size=14" };
...
//	{ .instance = "spacefm", .scratchkey = 'e', .flags = Floating },
	{ .instance = "spfm (r)", .scratchkey = 'r', .flags = Floating },
	// { .class = "Spacefm", .scratchkey = 't', .workspace = "7", .floatpos = "80% 80%", .flags = Centered|Floating|SemiScratchpad },
	{ .class = "Spacefm", .scratchkey = 't', .floatpos = "80% 80%", .flags = Centered|Floating},
	{ .class = "Slack", .scratchkey = 's', .floatpos = "50% 50% 80% 80%", .flags = Floating},
//	{ .class = "Slack", .scratchkey = 's', .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace|SemiScratchpad },
//
{ .instance = "ICE-SBB-evernote", .scratchkey = 'n', .floatpos = "80% 80%", .flags = Centered|Floating|SemiScratchpad },
	{ .class = "fubar", .flags = IgnoreCfgReqPos|IgnoreCfgReqSize },
...
/* 	{ .role = "browser", .workspace = "8", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace }, */
	{ .class = "Tweetdeck", .workspace = "1", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Element", .workspace = "1", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "VivRay", .workspace = "2", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Chrome", .workspace = "3", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Microsoft Teams - Preview", .workspace = "4", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "ICE-SBB-reddit", .workspace = "4", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "ICE-SSB-evernote", .workspace = "5", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Caprine", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Slack", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "discord", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
//	{ .title = "WhatsApp", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
//	{ .class = "ICE-SSB-whatsapp", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Whatsapp-for-linux", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Slack", .workspace = "6", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "TelegramDesktop", .workspace = "7", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "File-roller", .workspace = "7", .flags = Centered|Floating|SwitchWorkspace|RevertWorkspace },
	{ .class = "VivMail", .workspace = "8", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
//	{ .class = "ramboxpro", .workspace = "8", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
//	{ .class = "Ferdi", .workspace = "8", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
	{ .class = "Transmission", .workspace = "9", .flags = NoSwallow|SwitchWorkspace|RevertWorkspace },
//	{ .title = "tty-clock", .workspace = "1" , .flags = Floating|Sticky|NoSwallow|NoBorder},
	{ .class = "MyFancyClock", .workspace = "1", .floatpos = "100% 0%", .flags = Floating|NoSwallow|Sticky|NoBorder},
...
static const BarRule barrules[] = {
	...
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       1,     0,       5,   5,   9,     BAR_ALIGN_LEFT,        size_status,              draw_status,             click_status,             NULL,                     "status9" },
...
static const WorkspaceRule wsrules[] = {
	...
	{  "10",  -1,       0,       15,      -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,     "E1",   "",   "[E1]",},
	{  "11",  -1,       0,       15,      -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,     "E2",   "",   "[E2]",},
	{  "12",  -1,       0,       15,      -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,     "E3",   "",   "[E3]",},
};
...
static const char *termcmd[]  = { NULL, "alacritty", NULL };
// static const char *firecmd[]  = { NULL, "audacity", NULL };
...
static const char *spcmd1[] = {"e", "edex-ui", "-n", "spterm (e)", NULL };
static const char *spcmd2[] = {"w", "st", "-n", "spterm (w)", "-g", "120x34", NULL };
static const char *spcmd3[] = {"r", "st", "-n", "spfm (r)", "-g", "144x41", "-e", "ranger", NULL };
static const char *spcmd4[] = {"t", "spacefm",  NULL };
// static const char *spcmd5[] = {"s", "slack", NULL };
static const char *spcmd6[] = {"n", "/home/ray/scripts/evernote.sh", NULL };
...
static Key keys[] = {
	...
	{ KeyPress,   MODKEY|Alt,                   XK_0,            viewalloccwsonmon,      {0} },        // view all workspaces on the current monitor that has clients
...
//	STACKKEYS(AltGr|Ctrl|Shift,                      stackpush)                            // move the currently focused client to the nth place in the stack
	...
	SCRATCHKEYS(MODKEY,                    XK_e,                                    spcmd1)
	SCRATCHKEYS(MODKEY,                    XK_w,                                    spcmd2)
	SCRATCHKEYS(MODKEY,                    XK_r,                                    spcmd3)
	SCRATCHKEYS(MODKEY,                    XK_t,                                    spcmd4)
//	SCRATCHKEYS(MODKEY,                    XK_s,                                    spcmd5)
	SCRATCHKEYS(MODKEY,                    XK_n,                                    spcmd6)
	...
	WSKEYS(MODKEY|Ctrl,                          XK_F10,			                "10")
	WSKEYS(MODKEY|Ctrl,                          XK_F11,                                    "11")
	WSKEYS(MODKEY|Ctrl,                          XK_F12,                                    "12")
...
//	{ KeyPress,   MODKEY,                       XK_,             transferall,            {0} }, // swaps all clients in the stack area with all clients in the master area
	{ KeyPress,   MODKEY,                       XK_0,             togglesticky,           {0} }, // makes a client show on all workspaces)
...
//	{ KeyPress,   MODKEY,                       XK_,             switchcol,              {0} }, // changes focus between the master and the primary stack area
	{ KeyPress,   MODKEY|Alt,                       XK_g,             setlayout,              {.v = &layouts[12]} }, // sets a specific layout, see the layouts array for indices
//	{ KeyPress,   MODKEY,                       XK_,             xrdb,                   {0 } }, // reloads colors from XResources
};

static const char *rootmenu[] = { NULL, "/home/ray/scripts/switch_dusk_theme.sh", NULL };
...
//	{ ClkRootWin,                MODKEY|Ctrl,             Button1,        dragmfact,        {0} }, // dynamically change the size of the master area compared to the stack area(s)
	{ ClkRootWin,                0,                       Button1,        spawn,            {.v = rootmenu } }, // dynamically change the size of the master area compared to the stack area(s)
